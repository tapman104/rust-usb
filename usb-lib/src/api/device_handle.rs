...
impl DeviceHandle {
    ...
    pub fn control_transfer(
        ...
        self.inner.control_transfer(setup, data, timeout)
    }
    ...
    pub fn bulk_read(
        ...
        self.inner.bulk_read(endpoint, buf, timeout)
    }
    ...
    pub fn bulk_write(
        ...
        self.inner.bulk_write(endpoint, buf, timeout)
    }
    ...
    pub fn interrupt_write(
        ...
        self.inner.interrupt_write(endpoint, buf, timeout)
    }

    pub fn reset_pipe(&self, endpoint: u8) -> Result<(), UsbError> {
        self.inner.reset_pipe(endpoint)
    }

    pub fn abort_pipe(&self, endpoint: u8) -> Result<(), UsbError> {
        self.inner.abort_pipe(endpoint)
    }

    pub fn reset_device(&self) -> Result<(), UsbError> {
        self.inner.reset_device()
    }

    pub fn get_alternate_setting(&self, interface: u8) -> Result<u8, UsbError> {
        self.inner.get_alternate_setting(interface)
    }

    pub fn set_alternate_setting(&mut self, interface: u8, alt: u8) -> Result<(), UsbError> {
        self.inner.set_alternate_setting(interface, alt)
    }
    ...
    pub fn get_pipe_info(&self, endpoint: u8) -> Result<crate::core::EndpointInfo, UsbError> {
        self.inner.get_pipe_info(endpoint)
    }
    ...
    pub fn async_bulk_read(
        ...
        self.inner.async_bulk_read(endpoint, buf, timeout)
    }
    ...
    pub fn async_bulk_write(
        ...
        self.inner.async_bulk_write(endpoint, buf, timeout)
    }
    ...
    pub fn async_interrupt_read(
        ...
        self.inner.async_interrupt_read(endpoint, buf, timeout)
    }
    ...
    pub fn async_interrupt_write(
        ...
        self.inner.async_interrupt_write(endpoint, buf, timeout)
    }
    ...
    pub fn isoch_read(&self, endpoint: u8, buf: &mut [u8]) -> Result<usize, UsbError> {
        self.inner.isoch_read(endpoint, buf)
    }
    ...
    pub fn isoch_write(&self, endpoint: u8, buf: &[u8]) -> Result<usize, UsbError> {
        self.inner.isoch_write(endpoint, buf)
    }
}
